...
import { getTopGainers }  from "@/actions/market";
...
export const metadata: Metadata = {
  ...
  description: "7日間で最も値上がりしたトレカランキング。ポケカ・ワンピース・遊戯王の高騰カードをリアルタイム追跡。",
};

export default async function GainersPage() {
  const cards = await getTopGainers(50);
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3">
              <h1 className="text-2xl font-semibold text-navy">Top Gainers</h1>
