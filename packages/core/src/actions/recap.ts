...
import { getTrendingCards, getTopGainers, getTopLosers, getVolumeSpikes, type MarketCard } from "./market";
import { getLatestIndex, getPreviousDaySnapshot }                                          from "./indexValue";
import { GAMES }                                                                           from "../seo/games";
